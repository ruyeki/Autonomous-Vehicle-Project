...
//   if (class_id != "Car" && class_id != "Motorcycle" && class_id != "Decision")
//     {
...
//   HttpServer httpserver1(0001);
//   MotorCycleServer s(httpserver1, JSONRPC_SERVER_V2);
//   s.StartListening();
...
//   try {
//     jsonV3 = mycar3.move("move", "Motorcycle", LMotor.dump2JSON(), "85138089");
